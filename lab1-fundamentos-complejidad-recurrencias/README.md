...
<!-- EDITAR: reemplazar por el ejemplo real del autor -->
Un segundo ejemplo, distinto de Tamiza: [pendiente, completar con un caso propio: qué se procesaba, cuántos datos y qué restricción se incumplía].
